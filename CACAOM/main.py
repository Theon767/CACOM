...
filename='\\frames_210.jpg'
#video2image(path_read,path_write,'\\IMG_3997.MOV',10)# transform video to picture
...
max_contour=footdetector(path_write,filename,ksize1=(11,11),ksize2=(3,3))#using Canny&Contour to find the contour of 
                                                                            #feet 
